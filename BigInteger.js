    ...
    var bigInt = (function () {
        ...
        BigInteger.prototype.modPow = function (exp, mod) {
            ...
            while (exp.greater(0)) {
                ...
                console.log("r: " + r + "\t exp: " + exp + "\t base: " + base);
            }
            console.log("finally r: " + r);
            return r;
//            return toBase(mod, 16);

        };

        BigInteger.prototype.modPowTasks = function(exp, mod){
            exp = parseInput(exp);
            mod = parseInput(mod);
            if (mod.equals(ZERO)) throw new Error("Cannot take modPow with modulus 0");
            var r = ONE,
                base = this.mod(mod);
            if (base.equals(ZERO)) return ZERO;
//            _task(exp, mod, base, r);
//            return r;
            return _task(exp, mod, base, r);

            function _task(e, m, b, r){
                var i = 0, n = 10;
                while(e.greater(0) || i++ < n){
                    if (e.isOdd()) r = r.multiply(b).mod(m);
                    e = e.divide(2);
                    b = b.square().mod(m);
                }
                if(e.greater(0)){
...
//        BigInteger.prototype.montgomery = function()

//        BigInteger.prototype.simpleModPow = function (exp, mod) {
//            var a = [], remainder, len = 9;
//            for(var i = 0; i < len; i++){
//                var t = parseInput(16).pow(Math.pow(2, i));
////                console.log("" + t.toString());
//                a.push(t);
//            }
//            remainder = a[len - 1].mod(mod);
//            console.log("remainder: " + remainder);
//            while(exp.greater(0)){
//                for(i = len - 1; i; i--){
//                    if(remainder.greater(a[i])){
//                        var k = len - 2 - i;
//                        remainder = (remainder.multiply(a[k])).mod(mod);
//                        exp = exp.minus(k);
////                        console.log("remainder: " + remainder + "\t exp: " + exp + "\t k: " + k);
//                        break;
//                    }
//                }
//            }
...
//        var prime = bigInt(evt.PRIME),
//            base = bigInt(evt.BASE),
//            exp = bigInt(evt.EXP);
////        console.log("prime: " + prime);
////        console.log("base: " + base);
////        console.log("base: " + base);
//        setTimeout(function(){
//            var remainder = base.modPow(exp, prime);
